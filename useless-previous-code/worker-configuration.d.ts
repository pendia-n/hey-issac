/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5abc703f48bd47f8ce79b62841d1dcf6)
// Runtime types generated with workerd@1.20260831.1 2026-08-31 global_fetch_strictly_public
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	SEARCH_PROVIDER: "exa";
	RUNS: DurableObjectNamespace<import("./src/index").RunCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RunCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEARCH_PROVIDER">> {}
}
